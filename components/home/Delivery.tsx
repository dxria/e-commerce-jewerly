...
export default function Delivery() {
  return (
    <section className="w-5/6 text-center m-auto my-5 p-5 lg:flex lg:place-content-around items-center text-2xl text-rich-bordeaux border-rich-bordeaux border-2">
